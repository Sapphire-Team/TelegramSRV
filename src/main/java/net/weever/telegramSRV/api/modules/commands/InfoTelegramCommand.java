...
public class InfoTelegramCommand implements ITelegramCommand
{
    ...
    {
        String text = ConfigUtil.getLocalizedText("telegramCommands", "info.reply").replace("%tps%", String.valueOf((int) Bukkit.getTPS()[0])).replace("%playersCount%", String.valueOf(Bukkit.getOnlinePlayers().size()));
